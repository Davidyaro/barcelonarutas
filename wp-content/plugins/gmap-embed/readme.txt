...
**[Get WP Google Map pro version(Starting from 19$ only)](https://wpgooglemap.com/pricing?utm_source=wp_repo&utm_medium=readme_link&utm_campaign=readme_get_pro)**
...
* **[Video on Quick Installation](https://www.youtube.com/watch?v=1G2VksP-uX0)**
* **[Video on (Installation, Activation, Creating Map, How to use)](https://www.youtube.com/watch?v=ErRy5lqTPjY)**
...
To have continued the update, please donate for the WP Google Map plugin. **You will get Lifetime License Key by donating minimum 59 USD**
...
See the [Video](https://youtu.be/ErRy5lqTPjY?t=23) ,hope you will get idea.
...
After installing the plugin, Click on WP Google Map in the left sidebar. Then click on  **Add New** . [See Video Tutorial](https://youtu.be/ErRy5lqTPjY?t=141)
